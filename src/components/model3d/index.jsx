  ...
  return (
    <>
      ...
      <instancedMesh ref={mesh} args={[null, null, count]}>
        ...
        <meshPhongMaterial attach="material" color="#43B7A6" />
      </instancedMesh>
    </>
  )
}
...
export default function Model3D({isDarkMode}) {
  ...
  return (
    <Canvas
      // gl={{ antialias: true, toneMapping: NoToneMapping }} linear
      className="position-fixed start-0 top-0"
      ...
      <Swarm count={isMobile ? 500 : 1000} mouse={mouse} />
      <Lines count={50} mouse={mouse} colors={['#A2CCB6', '#FCEEB5', '#EE786E', '#e0feff', 'lightpink', 'lightblue']} />
      {
        isDarkMode && <Effect down={true} />
      }
    </Canvas>
  )
}